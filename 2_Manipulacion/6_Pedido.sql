...
INSERT INTO detalle_pedido VALUES
	...
	(@pedido_code, 'PRP-3', 'Semi pitillo', 100)
-- =======================================================================================================================================
...
UPDATE pedido
	SET superior = @verificar_super,
		inferior = @verificar_infer,
...
SELECT pedido.id_pedido AS 'ID Pedido', id_recibo AS 'ID Recibo',  pedido.id_transac AS 'ID Transaccion', id_empleado AS 'ID Empleado',
	   ...
	   num_comprobante AS 'N° Comprobante', fecha_p AS 'Fecha', superior AS 'M. Superior',
	   inferior AS 'M. Inferior',DESCrip AS 'Descripcion', precio_base_p AS 'Precio BASe',
